...
class _ErmDoctorPageState extends State<ErmDoctorPage> {
  ...
  List<Map<String, dynamic>> get filteredPatients {
    return patients.where((patient) {
      final nameMatch = patient["name"].toString().toLowerCase().contains(searchQuery.toLowerCase());
      final nikMatch = patient["nik"].toString().contains(searchQuery);
      final regMatch = patient["reg"].toString().contains(searchQuery);
      final searchMatch = searchQuery.isEmpty || nameMatch || nikMatch || regMatch;
      
      final doctorMatch = selectedDoctor == "Pilih Dokter Operator" || patient["doctor"] == selectedDoctor;
      final categoryMatch = patient["category"] == selectedFilter;
      
      bool dateMatch = true;
      if (selectedDate != null) {
        final regDate = DateTime.parse(patient["registrationDate"]);
        dateMatch = regDate.year == selectedDate!.year && 
                ...
                children: [
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: selectedDate != null ? const Color(0xFFEA580C) : const Color(0xFF1E40AF),
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          _buildFilterChip("Rawat Jalan", Icons.local_hospital),
                          const SizedBox(width: 12),
                          _buildFilterChip("Rawat Inap", Icons.hotel),
                          const SizedBox(width: 12),
                          _buildFilterChip("Unit Penunjang", Icons.support),
                          const SizedBox(width: 12),
                          _buildFilterChip("Operasi", Icons.medical_services),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Row(
                            children: [
                              Icon(Icons.filter_alt, size: 16, color: Color(0xFFB45309)),
                              SizedBox(width: 6),
                              Text(
                                "Filter Aktif:",
                                style: TextStyle(
                          ...
                          Wrap(
                            ...
                            children: [
                              if (selectedDoctor != "Pilih Dokter Operator")
                                _buildActiveFilterChip("Dokter: ${selectedDoctor}", () {
                                  setState(() {
                                    selectedDoctor = "Pilih Dokter Operator";
                                  });
                                }),
                              if (searchQuery.isNotEmpty)
                                _buildActiveFilterChip("Pencarian: $searchQuery", () {
                                  setState(() {
                                    searchController.clear();
                                    searchQuery = "";
                                  });
                              ...
                              if (selectedDate != null)
                                _buildActiveFilterChip("Tanggal: ${selectedDate!.day}/${selectedDate!.month}/${selectedDate!.year}", _clearDateFilter),
                            ],
                          ),
                        ],
                      ),
                  ...
                  if (filteredPatients.isNotEmpty)
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final childAspectRatio = getChildAspectRatio(constraints.maxWidth);
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              const Text("Tampilkan ", style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<int>(
                                    ...
                                    items: [5, 10, 20, 50].map((e) => DropdownMenuItem(
                                      value: e,
                              ...
                              const Text(" data", style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              const Text("Hal. 1 dari 3", style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                              const SizedBox(width: 8),
                              IconButton(
                                onPressed: () {},
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: data["operation"] == "Proses Operasi" 
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _buildActionButton("CPPT", Icons.description, const Color(0xFF6366F1)),
                        ),
                        const SizedBox(width: 6),
                        Expanded(
                          child: _buildActionButton("Diagnosa", Icons.medical_information, const Color(0xFF8B5CF6)),
                        ),
                        const SizedBox(width: 6),
                        Expanded(
                          child: _buildActionButton("Detail", Icons.visibility, const Color(0xFF06B6D4)),
                        ),
                      ],
                    ),
                  ],
